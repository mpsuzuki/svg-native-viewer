    ...
    const Path& path, const GraphicStyle& graphicStyle, const FillStyle& fillStyle, const StrokeStyle& strokeStyle)
{
    ...
    if (fillStyle.hasFill)
    {
        ...
        if (fillStyle.paint.type() == typeid(Gradient))
        {
            ...
            for (const auto& stop : gradient.colorStops)
            {
                ...
                QColor qColor;
                qColor.setRgbF(stopColor[0], stopColor[1], stopColor[2], stopColor[3] * fillStyle.fillOpacity);
        ...
        else
        {
            ...
            QColor qColor;
            qColor.setRgbF(color[0], color[1], color[2], color[3] * fillStyle.fillOpacity);
    ...
    if (strokeStyle.hasStroke && strokeStyle.lineWidth > 0)
    {
        ...
        QPen qPen;
        QColor qColor;
        qColor.setRgbF(color[0], color[1], color[2], color[3] * strokeStyle.strokeOpacity);
